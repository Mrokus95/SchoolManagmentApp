...
class LessonReport(models.Model):
    ...
    subject = models.ForeignKey(
        Subject,
        related_name='reports_subject',
        on_delete=models.CASCADE
        )
    teacher = models.ForeignKey(
        Teacher,
        related_name='reports_teacher',
        on_delete=models.CASCADE
        )
    class_unit = models.ForeignKey(
        ClassUnit,
        related_name='reports_class_unit',
        on_delete=models.CASCADE
        )
...
class Attendance(models.Model):
    lesson_report = models.ForeignKey(
        LessonReport,
        on_delete=models.CASCADE
        )
    ...
    def __str__(self):
        return (
            f"{self.student} - {self.lesson_report.create_date} - "
            f"{self.lesson_report.subject}: "
