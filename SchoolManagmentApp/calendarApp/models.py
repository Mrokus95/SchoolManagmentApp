...
class Lesson(models.Model):
    ...
    class_name = models.ForeignKey(
        ClassUnit, on_delete=models.CASCADE, null=False, blank=False
    )
    classroom = models.ForeignKey(Classroom, on_delete=models.CASCADE)
    date = models.DateField(null=False, blank=False)
    is_base = models.BooleanField(default=False)
    is_cancelled = models.BooleanField(default=False)
    classroom_reservation = models.OneToOneField(
        ClassroomReservation, on_delete=models.CASCADE
    )
    teacher_reservation = models.OneToOneField(
        TeacherReservation, on_delete=models.CASCADE
    )
